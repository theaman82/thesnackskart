    ...
    <div class="flex flex-col h-full">
        ...
        <div class="flex-1 py-6 px-3 space-y-2 overflow-y-auto">
           ...
           <div x-data="{ ProductOpen: false }" class="relative">
            ...
            <!-- Users -->
            <a href="{{ route('admin.manage.user') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-gray-700/50 transition-all duration-200 text-gray-300 group">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">

    ...
    <div class="px-4 sm:px-6 py-3">
            ...
            <div class="flex items-center gap-2 sm:gap-4">
                ...
                <div class="relative" x-data="{ open: false }">
                    <button @click="open = !open" class="flex items-center gap-2 focus:outline-none group">
                        <div
                            class="w-8 h-8 rounded-full bg-gradient-to-r from-indigo-500 to-purple-500 flex items-center justify-center text-white text-sm font-bold shadow-md">
                        ...
                        <svg class="hidden sm:block w-4 h-4 text-gray-500 group-hover:text-gray-700" fill="none"
                    ...
                    <div x-show="open" @click.away="open = false" x-transition:enter="transition ease-out duration-200"
                        ...
                        <button id="theme-toggle"
                            class="flex items-center gap-2 px-3 py-2 rounded-lg bg-gray-200 dark:bg-gray-800">

                            <span class="dark:hidden dark:text-white text-black">🌙 Dark</span>
                            <span class="hidden dark:inline dark:text-white text-black">🌞 Light</span>
        ...
        {{-- <div class="md:hidden mt-3">
            <div class="flex items-center bg-gray-100 rounded-lg px-3 py-2">
                ...
                <input type="text" 
                       placeholder="Search..." 
                       classtransparent outline-none ml-2 text-sm w-full text-gray-700 placeholder-gray-500">
            </div>
        </div> --}}
    </div>

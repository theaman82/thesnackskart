            ...
            <a href="/shop?category=roasted-makhana"
               class="group block bg-white rounded-xl overflow-hidden border border-gray-200 hover:border-amber-300 ">
                <div class="aspect-square bg-amber-50/40 flex items-center justify-center">
                    <img 
                        src="/banner/product-1.png" 
                        alt="Roasted Makhana" 
                        class="w-full h-full object-contain group-hover:scale-110 transition-transform duration-300"
                    >
                </div>
                <div class="p-4 text-center">
                    <h3 class="text-base md:text-lg font-medium text-gray-800 group-hover:text-amber-700 transition-colors">
                        Roasted Makhana
                    </h3>
                </div>
            </a>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            ...
            <div class="group bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                <div class="relative overflow-hidden">
                    <img src="/banner/1736159404-Cream-Onion.jpg" alt="Roasted Makhana" class="w-full  object-cover group-hover:scale-105 transition duration-300">
                ...
                <div class="p-4">
                    ...
                    <button class="w-full cursor-pointer mt-4 bg-amber-500 text-white py-2 rounded-lg hover:bg-amber-600 transition flex items-center justify-center gap-2">
            ...
            <!-- Card 2 - Spicy Makhana (Red Theme) -->
             <div class="group bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                <div class="relative overflow-hidden">
                    <img src="/banner/1771831586-pp makhana 1.jpg.jpeg" alt="Roasted Makhana" class="w-full  object-cover group-hover:scale-105 transition duration-300">
                    <button class="absolute top-3 right-3 w-8 h-8 bg-white rounded-full flex items-center justify-center shadow-md hover:bg-red-50 transition">
                        <svg class="w-4 h-4 text-gray-400 hover:text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"></path>
                        </svg>
            ...
            <!-- Card 3 - Organic Makhana (Green Theme) -->
             <div class="group bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                <div class="relative overflow-hidden">
                    <img src="/banner/1771831673-Makoni Front.jpg" alt="Roasted Makhana" class="w-full  object-cover group-hover:scale-105 transition duration-300">
                    <button class="absolute top-3 right-3 w-8 h-8 bg-white rounded-full flex items-center justify-center shadow-md hover:bg-red-50 transition">
                        <svg class="w-4 h-4 text-gray-400 hover:text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"></path>
                        </svg>
            ...
            <!-- Card 4 - Salted Makhana (Blue Theme) -->
              <div class="group bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                <div class="relative overflow-hidden">
                    <img src="/banner/1771421815-Honey.png" alt="Roasted Makhana" class="w-full  object-cover group-hover:scale-105 transition duration-300">
                    <button class="absolute top-3 right-3 w-8 h-8 bg-white rounded-full flex items-center justify-center shadow-md hover:bg-red-50 transition">
                        <svg class="w-4 h-4 text-gray-400 hover:text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"></path>
                        </svg>
                ...
                <div class="p-4">
                    ...
                    <button class="w-full mt-4 cursor-pointer bg-amber-500 text-white py-2 rounded-lg hover:bg-amber-600 transition flex items-center justify-center gap-2">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z"></path>
                        </svg>
                        Add to Cart
            ...
            <!-- Card 5 - Sweet Makhana (Pink Theme) -->
            
        </div>

        <!-- View All Button -->
        <div class="text-center mt-12">
            <a href="/shop" class="inline-block px-8 py-3 bg-gray-900 text-white rounded-lg hover:bg-gray-800 transition shadow-md">
                View All Products →
            </a>
        </div>
    </div>
   ...
   <section class="py-20 px-4 bg-gradient-to-b from-amber-50/80 to-white">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="text-center mb-16">
            <span class="inline-block px-4 py-1.5 bg-amber-100 text-amber-700 font-medium rounded-full text-sm mb-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
            ...
            <!-- Feature 1: Organic -->
            <div class="group relative bg-white rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
                <!-- Decorative Background -->
                <div class="absolute top-0 right-0 w-32 h-32 bg-green-100 rounded-bl-full -z-0 opacity-50"></div>
                
                <div class="relative z-10">
                    <!-- Custom SVG Icon -->
                    <div class="w-20 h-20 bg-gradient-to-br from-green-100 to-emerald-50 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                        <svg class="w-12 h-12 text-green-600" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M12 2C9 2 6 4 6 8C6 12 12 18 12 18C12 18 18 12 18 8C18 4 15 2 12 2Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" fill="currentColor" fill-opacity="0.2"/>
            ...
            <div class="group relative bg-white rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
                ...
                <div class="relative z-10">
                    <!-- Custom SVG Icon -->
                    <div class="w-20 h-20 bg-gradient-to-br from-blue-100 to-sky-50 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                        <svg class="w-12 h-12 text-blue-600" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M12 4H4V16H12" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M20 10H12V18H20V10Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" fill="currentColor" fill-opacity="0.2"/>
                    ...
                    <p class="text-stone-600 leading-relaxed">
                        From our warehouse to your kitchen in record time. We ensure your snacks reach you at peak freshness.
                    ...
                    <div class="mt-6 flex items-center gap-4 text-sm border-t border-stone-100 pt-4">
                        ...
                        <div class="flex items-center gap-1">
                            <svg class="w-4 h-4 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2 2 2 4-4 2 2 2-2 2 2 2-2 2 2"></path>
                            </svg>
            ...
            <div class="group relative bg-white rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
                ...
                <div class="relative z-10">
                    <!-- Custom SVG Icon -->
                    <div class="w-20 h-20 bg-gradient-to-br from-amber-100 to-orange-50 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                        <svg class="w-12 h-12 text-amber-600" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M3 10L12 3L21 10L18 13L12 8L6 13L3 10Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" fill="currentColor" fill-opacity="0.2"/>
                            <path d="M8 13V20H16V13" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    ...
                    <p class="text-stone-600 leading-relaxed">
                        Partnering with 500+ local farmers across Bihar. Fair trade practices that support farming communities.
        ...
        <div class="mt-16 bg-gradient-to-r from-amber-500 to-orange-500 rounded-3xl p-10 text-center text-white">
            ...
            <button class="bg-white text-amber-600 px-8 py-3 rounded-xl font-semibold hover:bg-stone-50 transition shadow-lg hover:shadow-xl inline-flex items-center gap-2">
                Shop Now
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12 mb-12">
            ...
            <div class="lg:col-span-2">
                ...
                <div class="flex gap-4">
                    <a href="#" class="w-10 h-10 bg-stone-800 rounded-lg flex items-center justify-center hover:bg-amber-500 hover:text-white transition-all duration-300 group">
                        <svg class="w-5 h-5 text-stone-400 group-hover:text-white" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div>
                ...
                <ul class="space-y-4">
                    <li>
                        <a href="/shop" class="text-stone-400 hover:text-amber-500 transition-colors flex items-center gap-2">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <li>
                        <a href="/about" class="text-stone-400 hover:text-amber-500 transition-colors flex items-center gap-2">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                            </svg>
                            Our Story
                    ...
                    <li>
                        <a href="/contact" class="text-stone-400 hover:text-amber-500 transition-colors flex items-center gap-2">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                            </svg>
                            Contact Us
                    ...
                    <li>
                        <a href="/blog" class="text-stone-400 hover:text-amber-500 transition-colors flex items-center gap-2">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                            </svg>
                            Blog & Recipes
            ...
            <div>
                ...
                <ul class="space-y-4">
                    <li>
                        <a href="#" class="text-stone-400 hover:text-amber-500 transition-colors flex items-center gap-2">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                            </svg>
                            FAQ
            ...
            <div>
                ...
                <div class="mt-6">
                    ...
                    <div class="flex">
                        <input type="email" placeholder="Your email" class="flex-1 px-4 py-2 bg-stone-800 border border-stone-700 rounded-l-lg focus:outline-none focus:border-amber-500 text-stone-300 text-sm">
                        <button class="px-4 py-2 bg-amber-500 text-white rounded-r-lg hover:bg-amber-600 transition flex items-center">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="border-t border-stone-800 pt-8 mb-8">
            <div class="flex flex-wrap items-center justify-between gap-4">
                <div class="flex items-center gap-4">
                    ...
                    <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/facebook/facebook-original.svg" alt="Visa" class="h-6 w-6 opacity-50 hover:opacity-100 transition">
